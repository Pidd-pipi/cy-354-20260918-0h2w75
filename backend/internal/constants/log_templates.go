...
const (
	...
	LogProductReservedSuccess         = "product reserved success: product_id=%d status=reserved"
	LogProductReleasedSuccess         = "product released success: product_id=%d status=on_sale"
