...
const (
	...
	LogProductReservedSuccess         = "product reserved success: product_id=%d order_id=%d status=reserved"
	LogProductRestoreOnSaleSuccess    = "product restore on_sale success: product_id=%d order_id=%d status=on_sale"
	...
	LogTradeOrderCancelSuccess        = "trade order cancel success: order_id=%d product_id=%d restored=on_sale"
	LogTradeOrderCreateConflict       = "trade order create conflict: product_id=%d buyer=%d error=%v"
